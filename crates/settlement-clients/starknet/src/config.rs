...
pub const ENV_STARKNET_FINALITY_RETRY_WAIT_IN_SECS: &str = "STARKNET_FINALITY_RETRY_WAIT_IN_SECS";
pub const DEFAULT_FINALITY_RETRY_WAIT: &str = "60";
...
impl SettlementConfig for StarknetSettlementConfig {
    ...
    fn new_from_env() -> Self {
        ...
        let tx_finality_retry_wait_in_seconds: u64 =
            get_env_var_or_default(ENV_STARKNET_FINALITY_RETRY_WAIT_IN_SECS, DEFAULT_FINALITY_RETRY_WAIT)
                .parse()
                .expect("STARKNET_FINALITY_RETRY_WAIT_IN_SECS should be a delay in seconds");
        StarknetSettlementConfig { rpc_url, core_contract_address, tx_finality_retry_wait_in_seconds }
    }
}
...
impl Default for StarknetSettlementConfig {
    fn default() -> Self {
        Self {
            ...
            tx_finality_retry_wait_in_seconds: 60,
        }
    }
}
