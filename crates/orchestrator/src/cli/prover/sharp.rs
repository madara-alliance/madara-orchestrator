...
#[group(requires_all = ["sharp_customer_id", "sharp_url", "sharp_user_crt", "sharp_user_key", "sharp_server_crt", "sharp_proof_layout", "gps_verifier_contract_address", "sharp_rpc_node_url"])]
