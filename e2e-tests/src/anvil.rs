...
impl AnvilSetup {
    ...
    pub async fn deploy_contracts(&self) -> (Address, Address) {
        ...
        let _ = verifier_client.setValid(fixed_bytes!("39bd5b4acc5065265a30f46e7652258599f5c511ff5c286bc86f08e3a877d9de")).send().await.expect("Failed to set fact as valid");
